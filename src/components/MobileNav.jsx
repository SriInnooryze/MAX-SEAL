...
const MOBILE_NAV = [
  ...
  },
  {
    id: 'about', label: 'About', href: routes.about, children: [
      { label: 'Company', href: routes.about + '#company' },
      { label: 'Team', href: routes.about + '#team' },
      { label: 'End Users', href: routes.about + '#end-users' },
      { label: 'Global Partners', href: routes.partners },
    ]
  },
